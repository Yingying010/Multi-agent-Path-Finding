...
from finalChallenge_RRTstar.rrtstar_cbs import run as rrt_run
...
rrt_run(dimensions=env_params["map"]["dimensions"], obstacles=env_params["map"]["obstacles"], agents=agent_yaml_params["agents"], out_file="finalChallenge_RRTstar/output/rrtstar_output.yaml")
cbs_schedule = read_cbs_output("finalChallenge_RRTstar/output/rrtstar_output.yaml")
